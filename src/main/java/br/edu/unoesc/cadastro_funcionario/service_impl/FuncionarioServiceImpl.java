...
public class FuncionarioServiceImpl implements FuncionarioService {
    ...
    public void popularInicial() {
        repositorio.saveAll(List.of(
                new Funcionario(null, "Fulano da Silva", 10, new BigDecimal("1500.34"), LocalDate.of(2000, 10, 2),"Rua x"),
                new Funcionario(null, "Spring Function", 0, new BigDecimal("2500.00"), LocalDate.of(2005, 9, 3),"Rua y"),
                new Funcionario(null, "Is dificult", 3, new BigDecimal("1800.00"), LocalDate.of(2002, 3, 21),"Rua z"),
                new Funcionario(null, "Lets Go", 7, new BigDecimal("1670.45"), LocalDate.of(1990, 6, 15),"Rua j"),
                new Funcionario(null, "Mariazinha das Graças", 0, new BigDecimal("23500.54"),
                        LocalDate.of(1998, 9, 17),"Rua a"),
                new Funcionario(null, "Joaozinho Public", 2, new BigDecimal("900.23"), LocalDate.of(1993, 1, 5),"Rua b"),
                new Funcionario(null, "Ms. Cabal", 1, new BigDecimal("5.98"), LocalDate.of(1790, 5, 19),"Rua e")));
    }
    ...
    @Override
    public Page<Funcionario> buscaPaginaPorNome(String nome,
                                                Integer pagina, 
                                                Integer tamPagina, 
                                                String campo,
                                                String direcao) {
